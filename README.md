...
Prior to the installation of the package, it is recommended to install
the Bioconductor dependencies separately.

``` r
# install.packages("BiocManager")
BiocManager::install(c("GenomeInfoDb", "GenomicRanges", "plyranges"))
```
